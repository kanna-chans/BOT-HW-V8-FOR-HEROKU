...
//=================================================//
const bal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `𝐀𝐃𝐈 𝐃𝐄𝐕-𝐒 𝐎𝐅𝐂🗿🇮🇩 ${ngazap(prefix)}`,"body": `𝐀𝐃𝐈 𝐃𝐄𝐕-𝐒 𝐎𝐅𝐂🗿🇮🇩 ${ngazap(prefix)}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: doc })
} 
// Target
const reply = (teks) => {
